...
if(isset($_SESSION['role'])){
  if(isset($allowedPages[$_SESSION['role']]) && in_array($page, $allowedPages[$_SESSION['role']]) && isSafePage($page) ){
    ...
    include 'pages/'.$page .'.php';
      ...
      header("Location: http://localhost:8080/anotherr/index.php?p=" . $allowedPages[$_SESSION['role']]['default_page']);
      exit();
    }
  ...
  include 'pages/' . $page . '.php';
    ...
    header("Location: http://localhost:8080/anotherr/index.php");
    exit();
  }
}
