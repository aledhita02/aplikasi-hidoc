...
<div class="main-content">
  <div class="page-content">
    <div class="container-fluid">
      ...
      <button type="button" class="btn btn-outline-primary mb-2 mt-2" data-toggle="modal"
      ...
      <table class="table table_spesialis">
        ...
        <tbody>
          ...
          foreach ($spesialis as $row):
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                  data-target="#edit_spesialis_<?= $row['id_spesialisasi'] ?>" data-whatever="@getbootstrap">Edit</button>
                |
            ...
            <div class="modal fade" id="delete_spesialis_<?= $row['id_spesialisasi'] ?>" tabindex="-1" role="dialog"
      ...
      <div class="modal fade" id="tambah_spesialis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
