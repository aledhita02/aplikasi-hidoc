		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xl-3 col-md-6">
					<!-- card -->
					<a href="index.php?p=tabel_dokter">
						...
						<div class="card card-h-100">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="flex-shrink-0 text-end dash-widget">
										<i class="fas fa-user fa-5x me-3 text-success"></i>
									</div>
								</div>
							</div><!-- end card body -->
						</div><!-- end card -->
						...
						<div class="card card-h-100">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="flex-shrink-0 text-end dash-widget">
										<i class="fas fa-clipboard fa-5x me-3 text-success"></i>
									</div>
								</div>
							</div><!-- end card body -->
						</div><!-- end card -->
