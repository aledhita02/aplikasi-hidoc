<div class="main-content">
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="col-lg-12">
				<div class="row edit_profile">
					...
					<div class="col-lg-6">
						...
						<a href="#" class="btn btn-outline-success tombol_edit_profile" data-toggle="modal"
							data-target="#edit_bio" data-whatever="@getbootstrap">Edit Profil</a>
					</div>

					<!-- tabel  -->
					<table class="table table_privacy mt-4">
						...
						<tbody>
							...
							<tr>
								...
								<td>Password</td>
								<td>*************</td>
								<td class="d-flex justify-content-center"><button type="button"
										class="btn btn-outline-success" data-toggle="modal" data-target="#edit_pw"
										data-whatever="@getbootstrap">Edit Password</button></td>
							</tr>
						</tbody>
					</table>
						...
						<form action="process/user/ubahUserBio_proses.php" method="post">
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<input type="tel" class="form-control" id="recipient-name" name="telepon"
										value="<?= $_SESSION['telp'] ?>" required>
								</div>
			...
			<!-- Edit Password -->
			<div class="modal fade" id="edit_pw" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
				aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
