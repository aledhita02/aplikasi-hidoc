                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-outline-danger" data-toggle="modal"
                          data-target="#delete_dokter_<?= $row['id_user'] ?>" data-whatever="@getbootstrap">
                          Delete
                        </button>
                        <button type="button" class="btn btn-outline-dark" data-toggle="modal"
                          data-target="#detail_dokter_<?= $row['id_user'] ?>"
                          data-whatever="@getbootstrap">Detail</button>
                      </td>
                    </tr>
                    ...
                    <div class="modal-body">
                      <form action="process/dokter/tambahDokter_proses.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-check-inline">
                            <input class="form-check-input" type="radio" id="exampleRadios2" value="Perempuan"
                              name="jk">
