...
// if ($buttonDoker > 0): disabled <?php endif; --button delete dokter
...
<div class="main-content">
  <div class="page-content">
    <div class="container-fluid">
      ...
      <button type="button" class="btn btn-outline-primary mb-2 mt-2" data-toggle="modal" data-target="#tambah_dokter"
        data-whatever="@getbootstrap">Tambah Dokter</button>
        ...
        <tbody>
          ...
          foreach ($lihatDokter as $row):
            ...
            <tr>
              ...
              <td>
                <button  type="button"
                  class="btn btn-outline-danger" data-toggle="modal" data-target="#delete_dokter_<?= $row['id_user'] ?>"
                  data-whatever="@getbootstrap">
                  Delete
                </button> |
                <button type="button" class="btn btn-outline-dark" data-toggle="modal"
                  data-target="#detail_dokter_<?= $row['id_user'] ?>" data-whatever="@getbootstrap">Detail</button>
              </td>
            </tr>

            <!-- Modal Delete Dokter -->
            <div class="modal fade" id="delete_dokter_<?= $row['id_user'] ?>" tabindex="-1" role="dialog"
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a
                      href="process/dokter/deleteDokter_proses.php?id=<?= $row['id_user'] ?>&&foto=<?= $row['foto_user'] ?>"><button
            ...
            <!-- Modal Detail Dokter -->
            <div class="modal fade" id="detail_dokter_<?= $row['id_user'] ?>" tabindex="-1" role="dialog"
              aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
      ...
      <!-- akhirtable Dokter-->
      <!-- Modal tambah Dokter -->
      <div class="modal fade" id="tambah_dokter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form action="process/dokter/tambahDokter_proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check-inline">
                    <input class="form-check-input" type="radio" id="exampleRadios1" value="Laki-Laki" name="jk"
                      checked>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="exampleFormControlSelect1" name="spesialis" required>
                    ...
                    foreach ($data as $row):
                      ...
                      ?>
                      <option value="<?= $row['kode_spesialisasi'] ?>">
                        <?= $row['nama_spesialisasi'] ?>
                      </option>
                      <?php
                    endforeach;
