...
<div class="d-flex">
  ...
  <div class="dropdown d-inline-block">
    <button type="button" class="btn text-white header-item noti-icon position-relative"
    ...
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
        ...
        <?php foreach ($tampilKonsul as $row): ?>
          ...
          <?php else:
            ...
            <div class="text-reset notification-item">
              <div class="d-flex">
                <img src=" <?= $row['foto_user'] ?>" class="me-3 rounded-circle avatar-sm" alt="user-pic">
                  ...
                  <div class="font-size-13 text-muted">
                    ...
                    <?php if ($row['status_konsul'] == 'process'): ?>
                      <a href="index.php?p=select_chat_blank&&id_konsul=<?= $row['id_konsultasi'] ?>"><button type="button"
                          class="btn tombol btn-success putih btn-sm float-right">Lihat
                          Konsul</button></a>
                    <?php elseif ($row['status_konsul'] == 'pending'): ?>
                      <a href="process/konsul/hapusKonsul_proses.php?id=<?= $row['id_konsultasi'] ?>"><button type="button"
                          class="btn tombol btn-danger putih btn-sm float-right">Batalkan</button> </a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
      ...
      <div class="p-2 border-top d-grid">
        <a class="btn btn-sm btn-link font-size-14 text-center text-success" href="index.php?p=viewMoreKonsul">
  ...
  <div class="dropdown d-inline-block ">
    <button type="button" class="btn header-item bg-success border-start border-end border-success text-white"
      id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <img class="rounded-circle header-profile-user" src="<?= $_SESSION['foto'] ?>" alt="Header Avatar">
    ...
    <div class="dropdown-menu col-4 dropdown-menu-end">
      ...
      <a class="dropdown-item" href="process/logout.php"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i>
        Logout</a>
    </div>
  </div>
